# SAM3D objects augmented by ICP

SAM3D + ICP is a point map enhanced SAM3D objects with ICP pose refinement. To run this repo, you need to first install all requirements that is needed by SAM3D objects, and request for our datasets that is generated by google scanned obejcts and YCB.

Pleasue consult with authors if you need our dataset. Email: [Xiang7976@gmal.com](Xiang7976@gmal.com)
